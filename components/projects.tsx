...
const projects = [
  {
    title: "Red Corporativa Bancaria",
    category: "Redes & Seguridad",
    description:
      "Implementación de red WAN segura para 50 sucursales con redundancia y alta disponibilidad.",
    tech: ["MPLS", "Cisco", "Firewall"],
  },
  {
    title: "Data Center Tier III",
    category: "Infraestructura",
    description:
      "Diseño y construcción de centro de datos con 99.98% de disponibilidad garantizada.",
    tech: ["VMware", "Dell EMC", "Schneider"],
  },
  {
    title: "Sistema VoIP Empresarial",
    category: "Telecomunicaciones",
    description:
      "Migración de telefonía tradicional a VoIP para 500+ extensiones con integración CRM.",
    tech: ["Asterisk", "SIP", "WebRTC"],
  },
  {
    title: "WiFi Campus Universitario",
    category: "Wireless",
    description:
      "Despliegue de red WiFi 6 para campus con 10,000+ usuarios simultáneos.",
    tech: ["Aruba", "WiFi 6", "NAC"],
  },
];
