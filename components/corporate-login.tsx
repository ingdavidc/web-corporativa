...
interface Inspeccion {
  ...
  [key: string]: any; // Para los demás campos dinámicos
}
...
export default function PanelPage() {
  ...
  const handleUpdate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setEditDoc(null); // Cierra el modal
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-white/10 text-cyan-400">
                ...
                <th className="py-4 px-4 font-semibold">ID Punto</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 overflow-y-auto">
          <div className="bg-[#0a0a0a] border border-yellow-500/30 p-6 md:p-8 rounded-2xl w-full max-w-lg shadow-[0_0_50px_rgba(234,179,8,0.15)] my-8">
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              <div>
                <label className="text-sm font-semibold text-gray-300 block mb-1">ID del Punto de Red:</label>
              ...
              <div>
                <label className="text-sm font-semibold text-gray-300 block mb-1">Ubicación Física:</label>
              ...
              <div>
                <label className="text-sm font-semibold text-gray-300 block mb-1">Puerto del Switch:</label>
